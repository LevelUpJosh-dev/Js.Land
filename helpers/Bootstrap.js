...
!function (t, e) {
  ...
  const U = {
      ...
      getDataAttributes(t) {
        if (!t) return {};
        const e = {};
        return Object.keys(t.dataset).filter((t) => t.startsWith("bs")).forEach(
          (i) => {
            let n = i.replace(/^bs/, "");
  ...
  class pt extends B {
    ...
    _initializeChildren() {
      ...
      const t = V.find(ut, this._config.parent);
      V.find(ft, this._config.parent).filter((e) => !t.includes(e)).forEach(
        (t) => {
          const e = n(t);
  ...
  function de(t) {
    ...
    if (c) {
      ...
      w === Wt(i) && "static" !== Yt(w = Gt(i)).position && "absolute" === a &&
    ...
    var i = e,
      ...
      v = function (t, e, i) {
        var n = "clippingParents" === e
            ? function (t) {
              var e = Ae(Zt(t)),
                i = ["absolute", "fixed"].indexOf(Yt(t).position) >= 0 && zt(t)
                  ? te(t)
                  : t;
              return $t(i)
                ? e.filter(function (t) {
  ...
  class bi {
    ...
    _getConfig(t) {
      return (t = { ...pi, ..."object" == typeof t ? t : {} }).rootElement = r(
        t.rootElement,
      ),
        a("backdrop", t, mi),
        t;
