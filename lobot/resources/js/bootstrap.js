...
!function (t, e) {
    ...
    const t = 'transitionend',
            ...
            Object.keys(i).forEach((n) => {
                const s = i[n],
                    ...
                    a = r && o(r)
                        ...
                        : null == (l = r)
                        ? `${l}`
                        : {}.toString.call(l).match(/\s([a-z]+)/i)[1]
                            .toLowerCase();
                var l;
        ...
        c = (t) =>
            ...
            (void 0 !== t.disabled ? t.disabled : t.hasAttribute('disabled') &&
            ...
            getDataAttributes(t) {
                ...
                return Object.keys(t.dataset).filter((t) => t.startsWith('bs'))
                    .forEach(
                        (i) => {
                            let n = i.replace(/^bs/, '');
                            n = n.charAt(0).toLowerCase() +
                                n.slice(1, n.length), e[n] = q(t.dataset[i]);
                        },
                    ),
                    e;
            },
    ...
    class st extends B {
        ...
        _addTouchEventListeners() {
            const t = (t) =>
                ...
                e = (e) => {
                    t(e) ? this.touchStartX = e.clientX : this._pointerEvent ||
    ...
    function Zt(t) {
        return 'html' === Rt(t)
            ? t
            : t.assignedSlot || t.parentNode || (qt(t) ? t.host : null) ||
                Gt(t);
    }
    function Jt(t) {
        ...
        fn: function (t) {
            ...
            if (o && r) {
                var h = function (t, e) {
                    ...
                    g = te(o),
                    _ = g
                        ? 'y' === l ? g.clientHeight || 0 : g.clientWidth || 0
                        : 0,
                    b = p / 2 - m / 2,
                    v = h[u],
                    y = _ - d[c] - h[f],
    ...
    function de(t) {
        ...
        return l
            ? Object.assign(
                ...
                ((T = {})[v] = _ ? '0' : '',
                    T[b] = g ? '0' : '',
                    T.transform = (y.devicePixelRatio || 1) <= 1
                        ? 'translate(' + f + 'px, ' + m + 'px)'
    ...
    class hi extends B {
        ...
        static clearMenus(t) {
            if (
                t && (2 === t.button || 'keyup' === t.type && 'Tab' !== t.key)
            ) {
                return;
            }
            const e = V.find(ti);
    ...
    class un extends B {
        ...
        show() {
            ...
            H.set(n, this.constructor.DATA_KEY, this),
                ...
                this._popper ? this._popper.update() : this._popper = qe(
                    this._element,
                    n,
        ...
        _leave(t, e) {
            e = this._initializeOnDelegatedTarget(t, e),
                t &&
                (e._activeTrigger['focusout' === t.type ? dn : hn] = e._element
    ...
    class An extends B {
        ...
        _clear() {
            V.find(wn, this._config.target).filter((t) =>
